...
class NotificationController extends ChangeNotifier {
  ...
  static Future<void> getInitialNotificationAction() async {
    ReceivedAction? receivedAction =
        await AwesomeNotifications().getInitialNotificationAction(removeFromActionEvents: true);
...
class _AppState extends State<MyApp> {
  ...
  List<Route<dynamic>> onGenerateInitialRoutes(String initialRouteName) {
    ...
    pageStack.add(MaterialPageRoute(
        builder: (_) => const MyHomePage(title: 'Awesome Notifications FCM Example App')));
    final initialAction = NotificationController().initialAction;
    print("initial action: ${initialAction}");
    if (initialAction != null) {
      pageStack
          .add(MaterialPageRoute(builder: (_) => NotificationPage(receivedAction: initialAction)));
    }
    return pageStack;
  }
